...
6. Fuer den eigenen Zeitraum im WebFront Start und Ende im Format `TT.MM.JJJJ HH:MM` setzen und `Update` druecken.
7. Sicherstellen, dass alle Variablen im Archive Control aktiv aggregiert werden.
